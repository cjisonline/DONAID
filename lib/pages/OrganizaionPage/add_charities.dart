...
class addCharityPage extends StatefulWidget {
  ...
  const addCharityPage({Key? key}) : super(key: key);

  @override
  _NavState createState() => _NavState();
}
class _NavState extends State<addCharityPage> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      drawer: Drawer(
        ...
        //Add stuff for the hamburger menu
      ),
      appBar: AppBar(
        title: Text('DONAID'),
        actions: <Widget>[
      ...
      body: Stack(
        children: [
          ListView(
            children:<Widget>[
              Text('Create Charity', style: TextStyle(fontSize: 40, color: Colors.white),),
              ...
              FormBuilderDateRangePicker(
                ...
                decoration: InputDecoration(
                  ...
                  helperText: 'Provide the range money is by ex.2/10/2022 - 8/10/2022',
                  hintText: 'Hint text',
