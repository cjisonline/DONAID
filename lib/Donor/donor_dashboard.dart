...
class _DonorDashboardState extends State<DonorDashboard> {
  ...
  _getBeneficiariesAndAdoptions() async {
    ...
    if(_auth.currentUser?.email != null) {
      ...
      * We sort this list using the algorithm ( ([AmountRaised]/[GoalAmount])/[TodayDateTime - DateCreated] )
      * This algorithm essentially calculates the average percent of the goal amount that each beneficiary/adoption has raised per day since it was
      ...
      *  */
      beneficiariesAndAdoptions.sort((b, a) =>
          ((a.amountRaised/a.goalAmount)/today.difference(a.dateCreated.toDate()).inDays)
              .compareTo((b.amountRaised/b.goalAmount)/today.difference(a.dateCreated.toDate()).inDays));
    }
    else{
      beneficiariesAndAdoptions.addAll(beneficiaries);
    }
